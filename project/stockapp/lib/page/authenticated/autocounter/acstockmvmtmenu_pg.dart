...
class ACStockMvmtMenuPage extends StatefulWidget {
  final Map<String, dynamic> requestMap;

  final Map<String, dynamic> productDetails;
  final int currentQty;

  const ACStockMvmtMenuPage({super.key, required this.requestMap, required this.productDetails, this.currentQty = 0});

  @override
  State<ACStockMvmtMenuPage> createState() => _ACStockMvmtMenuPageState();

}

class _ACStockMvmtMenuPageState extends State<ACStockMvmtMenuPage>{
  ...
  void count() async {
    ...
    // navigateTo(context, widget, ACStockMvmtResultPage(resultImage: testdecode, resultQty: 10, requestMap: widget.requestMap, productDetails: productDetails, totalQty: currentQty,), animationType: 'scrollRight');
    ...
    try{
      ...
      if(response.statusCode == 200){
        ...
        navigateTo(context, widget, ACStockMvmtResultPage(resultImage: base64DecodeStr, resultQty: qty, requestMap: widget.requestMap, productDetails: productDetails, totalQty: currentQty,), animationType: 'scrollRight');
                          ...
                          Padding(
                            ...
                            child: 
                              Row(
                                ...
                                children: <Widget>[
                                  createText(
                                    'Expected Qty : ${widget.requestMap['Quantity'].toString()}',
                                    fontSize: sub3s,
                                    fontWeight: sub3w,
                                    textColor: Theme.of(context).colorScheme.onBackground,
                                  ),
