...
import 'package:stockapp/page/authenticated/reportandanalytics/purchaserptyrdisplay_pg.dart';
...
class PurchaseReportYrMenuPage extends StatefulWidget {
  const PurchaseReportYrMenuPage({super.key,});
  

  @override
  State<PurchaseReportYrMenuPage> createState() => _PurchaseReportYrMenuPageState();
}

class _PurchaseReportYrMenuPageState extends State<PurchaseReportYrMenuPage>{
  ...
  void generate(){
    ...
    if(outletid != 0){
      navigateTo(context, widget, PurchaseReportYrDisplayPage(outletid: outletid, year: int.parse(_dropdownMonthValue!),), animationType: 'scrollRight');
    }
