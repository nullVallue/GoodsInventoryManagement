...
class PurchaseReportDisplayPage extends StatefulWidget {
  final int outletid;
  final String month;
  const PurchaseReportDisplayPage({super.key, required this.outletid, required this.month});
  

  @override
  State<PurchaseReportDisplayPage> createState() => _PurchaseReportDisplayPageState();
}

class _PurchaseReportDisplayPageState extends State<PurchaseReportDisplayPage>{
