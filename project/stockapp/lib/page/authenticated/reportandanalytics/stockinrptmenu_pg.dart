...
class StockInReportMenuPage extends StatefulWidget {
  const StockInReportMenuPage({super.key,});
  

  @override
  State<StockInReportMenuPage> createState() => _StockInReportMenuPageState();
}

class _StockInReportMenuPageState extends State<StockInReportMenuPage>{
  ...
  void generate(){
    ...
    if(outletid != 0){
      navigateTo(context, widget, StockInReportDisplayPage(outletid: outletid, month: _dropdownMonthValue!,), animationType: 'scrollRight');
    }
