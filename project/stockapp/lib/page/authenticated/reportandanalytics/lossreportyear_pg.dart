...
import 'package:stockapp/page/authenticated/reportandanalytics/lossreportyrdisplay_pg.dart';
...
class LossReportYearPage extends StatefulWidget {
  const LossReportYearPage({super.key,});
  

  @override
  State<LossReportYearPage> createState() => _LossReportYearPageState();
}

class _LossReportYearPageState extends State<LossReportYearPage>{
  ...
  void generate(){
    ...
    if(outletid != 0){
      navigateTo(context, widget, LossReportYrDisplayPage(outletid: outletid, year: int.parse(_dropdownMonthValue!),), animationType: 'scrollRight');
    }
