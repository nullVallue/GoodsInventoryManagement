...
import 'package:stockapp/page/authenticated/reportandanalytics/purchaserptyear_pg.dart';
...
class PurchaseReportTypeMenuPage extends StatefulWidget {
  const PurchaseReportTypeMenuPage({super.key,});
  

  @override
  State<PurchaseReportTypeMenuPage> createState() => _PurchaseReportTypeMenuPageState();
}

class _PurchaseReportTypeMenuPageState extends State<PurchaseReportTypeMenuPage>{
  ...
  void generate(){
    ...
    if(_dropdownMonthValue == 'Monthly'){
      navigateTo(context, widget, PurchaseReportMenuPage(), animationType : 'scrollRight');
    }
    else{
      navigateTo(context, widget, PurchaseReportYrMenuPage(), animationType : 'scrollRight');
    }
