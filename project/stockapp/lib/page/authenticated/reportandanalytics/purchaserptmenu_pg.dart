...
class PurchaseReportMenuPage extends StatefulWidget {
  const PurchaseReportMenuPage({super.key,});
  

  @override
  State<PurchaseReportMenuPage> createState() => _PurchaseReportMenuPageState();
}

class _PurchaseReportMenuPageState extends State<PurchaseReportMenuPage>{
  ...
  void generate(){
    ...
    if(outletid != 0){
      navigateTo(context, widget, PurchaseReportDisplayPage(outletid: outletid, month: _dropdownMonthValue!,), animationType: 'scrollRight');
    }
