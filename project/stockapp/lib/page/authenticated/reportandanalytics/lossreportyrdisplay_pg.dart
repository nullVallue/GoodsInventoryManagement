...
class LossReportYrDisplayPage extends StatefulWidget {
  final int outletid;
  final int year;
  const LossReportYrDisplayPage({super.key, required this.outletid, required this.year});
  

  @override
  State<LossReportYrDisplayPage> createState() => _LossReportYrDisplayPageState();
}

class _LossReportYrDisplayPageState extends State<LossReportYrDisplayPage>{
    ...
    if(itemList.isEmpty){
      ...
      if(lossList.isNotEmpty){
        ...
        for(int i = 0; i < lossList.length; i++){
          ...
          if(lossList[i]['LossTimestamp'].toDate().year == widget.year){
            bool found = false;
            int foundIndex = 0;
                    ...
                    Padding(
                      ...
                      child: 
                        Row(
                          ...
                          children: <Widget>[
                            createText(
                              '${widget.year.toString()} Loss Report',
                              fontSize: h4s,
                              fontWeight: h2w,
