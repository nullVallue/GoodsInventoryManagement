...
class LossReportMenuPage extends StatefulWidget {
  const LossReportMenuPage({super.key,});
  

  @override
  State<LossReportMenuPage> createState() => _LossReportMenuPageState();
}

class _LossReportMenuPageState extends State<LossReportMenuPage>{
  ...
  void generate(){
    ...
    if(outletid != 0){
      navigateTo(context, widget, LossReportDisplayPage(outletid: outletid, month: _dropdownMonthValue!,), animationType: 'scrollRight');
    }
