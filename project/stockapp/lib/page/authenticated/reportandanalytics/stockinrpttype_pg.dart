...
import 'package:stockapp/page/authenticated/reportandanalytics/stockinyear_pg.dart';
...
class StockInReportTypeMenuPage extends StatefulWidget {
  const StockInReportTypeMenuPage({super.key,});
  

  @override
  State<StockInReportTypeMenuPage> createState() => _StockInReportTypeMenuPageState();
}

class _StockInReportTypeMenuPageState extends State<StockInReportTypeMenuPage>{
  ...
  void generate(){
    ...
    if(_dropdownMonthValue == 'Monthly'){
      navigateTo(context, widget, StockInReportMenuPage(), animationType : 'scrollRight');
    }
    else{
      navigateTo(context, widget, StockInReportYrMenuPage(), animationType : 'scrollRight');
    }
