...
class StockInReportYrDisplayPage extends StatefulWidget {
  final int outletid;
  final int year;
  const StockInReportYrDisplayPage({super.key, required this.outletid, required this.year});
  

  @override
  State<StockInReportYrDisplayPage> createState() => _StockInReportYrDisplayPageState();
}

class _StockInReportYrDisplayPageState extends State<StockInReportYrDisplayPage>{
