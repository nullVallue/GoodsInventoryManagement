...
import 'package:stockapp/page/authenticated/user/adduseraddr_pg.dart';
...
class AddUserDetailsPage extends StatefulWidget {
  ...
  const AddUserDetailsPage({super.key, required this.userDetails});

  @override
  State<AddUserDetailsPage> createState() => _AddUserDetailsPageState();
}
...
// Section 1
                    ...
                    Container(
                      ...
                      Row(
                        children: <Widget>[
                        BackButton(
                          onPressed: ()=> navigateTo(context, widget, AddUserPage(), animationType : 'scrollLeft'),
                        )
                        ]
                      ),
                    ),
...
// continue button
                      Padding(
                        padding: EdgeInsets.fromLTRB(0, (sWidth * 0.1), 0, (sWidth * 0.05)), // set top and bottom padding
                        child: 
                          Row(
                                ...
                                child:
                                 createButton(
                                  ...
                                  onPressed: () => {
                                    ...
                                    navigateTo(context, widget, AddUserAddrPage(
                                      userDetails: {
