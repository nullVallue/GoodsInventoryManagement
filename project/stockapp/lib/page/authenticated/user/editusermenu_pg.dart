...
class EditUserMenuPage extends StatefulWidget {
  final String editUserEmail;

  const EditUserMenuPage({super.key, required this.editUserEmail});

  @override
  State<EditUserMenuPage> createState() => _EditUserMenuPageState();
}

class _EditUserMenuPageState extends State<EditUserMenuPage>{
  ...
  switchStatus(bool isActive, String email) async {
    await DatabaseMethods.updateUserStatus(isActive, email);
    String status = '';
    if(isActive){
      status = 'Active';
    }
  ...
  void initState(){
    super.initState();
    userEmail = widget.editUserEmail;
  }
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  createSwitch(
                                    ...
                                    value: (userDetails['Status'] == 'Active')?true:false,
                                    onChanged: (value){
                                      switchStatus(value, userDetails['Email']);
                                    }
                                  ),
                                ],
                              ),
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: 
                                      ...
                                      iconOffset: 20,
                                      onPressed: () => {
                                        navigateTo(context, widget, EditUserAccountPage(editUserMap: userDetails), animationType : 'scrollRight')
                                      },
                                      ),
                                  ),
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: 
                                      ...
                                      iconOffset: 20,
                                      onPressed: () => {
                                        navigateTo(context, widget, EditUserAddressPage(editUserMap: userDetails), animationType : 'scrollRight')
                                      },
                                      ),
                                  ),
