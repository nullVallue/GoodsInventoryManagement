...
class SignUpAddrPage extends StatefulWidget {
  final Map userDetails;

  const SignUpAddrPage({super.key, required this.userDetails});

  @override
  State<SignUpAddrPage> createState() => _SignUpAddrPageState();
}

class _SignUpAddrPageState extends State<SignUpAddrPage>{
  ...
  registerSuccess(BuildContext oriContext){
    ...
    showAlertDialog(
      ...
      btnOnPressed: () => {
        ...
        navigateTo(oriContext, widget, SessionWrapper(), animationType: "scrollLeft"),
        // Navigator.push(
        //   context,
  ...
  registerFail(BuildContext oriContext){
    ...
    showAlertDialog(
      ...
      btnOnPressed: () => {
        Navigator.of(context).pop(),
        navigateTo(oriContext, widget, SignUpPage(), animationType: "scrollRight"),
        // Navigator.push(
        //   context,
        //   MaterialPageRoute(builder: (context) => SignUpPage()),
        // ),
...
//section 1
                    Container(
                      ...
                      Row(
                        children: <Widget>[
                        BackButton(
                          onPressed: ()=> navigateTo(context, widget, SignUpDetailsPage(userDetails: widget.userDetails), animationType : 'scrollLeft'),
                        )
                        ]
                      ),
                    ),
